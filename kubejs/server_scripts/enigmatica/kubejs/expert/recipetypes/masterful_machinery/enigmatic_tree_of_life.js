onEvent('recipes', (event) => {
    ...
    const recipes = [
        ...
        },
        {
            ...
            inputs: [
                { type: 'masterfulmachinery:items', data: { item: 'aeadditions:item_storage_cell_4096', count: 2 } },
                {
                    type: 'masterfulmachinery:items',
                    data: { item: 'aeadditions:fluid_storage_cell_4096', count: 2 }
                },
                ...
                { type: 'masterfulmachinery:items', data: { item: 'appliedenergistics2:quantum_ring', count: 64 } },
                { type: 'masterfulmachinery:items', data: { item: 'appliedenergistics2:quantum_link', count: 8 } },
                { type: 'masterfulmachinery:items', data: { item: 'appliedenergistics2:quantum_entangled_singularity', count: 2 } },
        ...
        },
        {
            ...
            inputs: [
                ...
                { type: 'masterfulmachinery:items', data: { item: 'appliedenergistics2:molecular_assembler', count: 32 } },
                { type: 'masterfulmachinery:items', data: { item: 'appliedenergistics2:interface', count: 4 } },
                { type: 'masterfulmachinery:items', data: { item: 'appliedenergistics2:pattern_terminal', count: 1 } },
                { type: 'masterfulmachinery:items', data: { item: 'appliedenergistics2:blank_pattern', count: 64 } },
                { type: 'masterfulmachinery:items', data: { item: 'appliedenergistics2:fluix_smart_cable', count: 64 } },
