onEvent('recipes', (event) => {
    ...
    const recipes = [
        ...
        },
        {
            ...
            outputs: [
                Item.of('6x naturesaura:ancient_planks'),
        ...
        },
        {
            ...
            outputs: [
                Item.of('6x botania:livingwood_planks'),
                Item.of('emendatusenigmatica:wood_dust').chance(0.25)
            ],
        ...
        },
        {
            ...
            outputs: [
                Item.of('6x astralsorcery:infused_wood_planks'),
                Item.of('astralsorcery:stardust').chance(0.01)
            ],
        ...
        },
        {
            ...
            outputs: [
                ...
                Item.of('emendatusenigmatica:quartz_dust').chance(0.375)
            ],
