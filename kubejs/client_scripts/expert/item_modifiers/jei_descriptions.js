onEvent('jei.information', (event) => {
    ...
    disabledItems.forEach((item) => {
        event.add(
            item,
            "This item has been disabled in Expert mode, if you managed to obtain it please report it on Enigmatica 6 Enlightened's issue tracker: https://github.com/ZZZank/Enigmatica6Enlightened/issues"
        );
    });
});
